function [dissimilarities] = cvPearson(eeg_data, labels, num_permutations)
%-------------------------------------------------------------------
%  [dissimilarities] = cvPearson(eeg_data, labels, num_permutations)
%-------------------------------------------------------------------
% Nathan Kong
%
% Returns pairwise dissimilarities with respect to cross-validated
% Pearson correlation.
% Input Args:
