...
% require a Representational Dissimilarity Matrix (RDM) or a Confusion 
% Matrix  (CM) as input. Below is an example call to the function 
% plotMDS():
%
% RSA = MatClassRSA;
...
% plotMDS(RDM);
%
% Below are the list of visualization functions contained in this class:
%   - plotDendrogram()
%   - plotMatrix()
%   - plotMDS()  
%   - plotMST()
