...
tic
C_noopt = RSA.classify.crossValidateMulti(X_shuf, Y_shuf, 'PCA', .99, 'classifier', 'LDA', 'PCAinFold', 0);
toc
...
[r c] = size(X_avg);
C_opt = RSA.classify.crossValidateMulti(X_avg, Y_avg, 'PCA', .99, 'classifier', 'LDA');
