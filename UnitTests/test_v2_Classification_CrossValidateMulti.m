...
M = Classification.crossValidateMulti(S01.X, S01.labels6);
...
M = Classification.crossValidateMulti(S01.X, S01.labels6, 'rngType', {0,'twister'});
M.classificationInfo
...
M = Classification.crossValidateMulti_opt(S01.X, S01.labels6, 'rngType', {4,'twister'}, 'nFolds', 4);
M.classificationInfo



%%
M = Classification.crossValidatePairs(S01.X, S01.labels6);
M.classificationInfo;
%% test PCA = 0, 72 class -- ERROR
M2 = Classification.crossValidateMulti(S01.X, S01.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0, ...
    'nFolds', 3 ...
    );
...
M2 = Classification.crossValidateMulti(S01.X, S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0, ...
    'nFolds', 3 ...
    );
...
M = Classification.crossValidateMulti( SL100.X(1:6, :) , ['a' 'a' 'b' 'b' 'c' 'c'], ...
    'classifier', 'LDA', ...
    'PCA', 0.9, ...
    'nFolds', 3, ...
    'rngType', 1 ...
...
M = Classification.crossValidateMulti( SL100.X(1:6, :) , ['BA', 'LO', 'CB', 'NM', 'PT', 'RM'], ...
    'classifier', 'LDA', ...
    'PCA', 0.9, ...
    'nFolds', 3, ...
    'rngType', 1 ...
...
M = Classification.crossValidateMulti( SL100.X(1:6, :) , [9 9 25 25 2 2], ...
    'classifier', 'LDA', ...
    'PCA', 0.9, ...
    'nFolds', 3, ...
    'rngType', 1 ...
...
M = Classification.crossValidateMulti( SL100.X(1:6, :) , [1 1 2 2 3.1 3.1], ...
    'classifier', 'RF', ...
    'PCA', 0.9, ...
    'nFolds', 3, ...
    'rngType', 1 ...
...
M_CC = Classification.crossValidateMulti( SL100.X , SL100.Y, ...
    'classifier', 'RF', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M_CC = Classification.crossValidateMulti( S01.X , S01.labels6, ...
    'classifier', 'RF', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M_1 = Classification.crossValidateMulti(S01.X , S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3, ...
    'numTrees', 200 ...
...
M_2 = Classification.crossValidateMulti(S01.X , S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 1.0, ...
    'nFolds', 3 ...
);
...
M_3 = Classification.crossValidateMulti(S01.X , S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 1.1, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01.X, S01.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_6class_slightlyUnbalanced.X, S01_6class_slightlyUnbalanced.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_6class_veryUnbalanced.X, S01_6class_veryUnbalanced.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_72class_slightlyUnbalanced.X, S01_72class_slightlyUnbalanced.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_72class_veryUnbalanced.X, S01_72class_veryUnbalanced.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_72class_lowCountUnbalanced.X, S01_72class_lowCountUnbalanced.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
M = Classification.crossValidateMulti(S01_6class_lowCountUnbalanced.X, S01_6class_lowCountUnbalanced.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
);
...
[Xnorm, sigma] = Preprocessing.noiseNormalization(S01.X, S01.labels72);
M = Classification.crossValidateMulti(S01.X, S01.labels72, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
...
[Xnorm, sigma] = Preprocessing.noiseNormalization(S01.X, S01.labels6);
M = Classification.crossValidateMulti(Xnorm, S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
    );
...
M2 = Classification.crossValidateMulti(Xnorm, S01.labels6, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
    );
...
[Xnorm, sigma] = Preprocessing.noiseNormalization(SL100.X, SL100.Y);
M = Classification.crossValidateMulti(Xnorm, SL100.Y, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
    );
...
M2 = Classification.crossValidateMulti(SL100.X, SL100.Y, ...
    'classifier', 'LDA', ...
    'PCA', 0.99, ...
    'nFolds', 3 ...
    );
...
[Xavg, Yavg] = Preprocessing.averageTrials(S01.X, S01.labels72, 5);
...
[Xavg, Yavg] = Preprocessing.averageTrials(S01.X, S01.labels6, 5);
...
[Xavg, Yavg] = Preprocessing.averageTrials(SL100.X, SL100.Y, 5, SL100.P);
M = Classification.crossValidateMulti(Xavg, Yavg, ...
    'classifier', 'LDA', ...
    'nFolds', 3 ...
    );
...
M2 = Classification.crossValidateMulti(SL500.X, SL500.Y, ...
    'classifier', 'LDA', ...
    'nFolds', 3 ...
    );
M2.classificationInfo
