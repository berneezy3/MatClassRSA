...
figure;
RSA.Visualization.plotMDS(ec_rdms, 'dimensions', [1 2]);

%% Plot MDS with >2 dimensions (should break)
% Looks good, breaks as expected

figure;
RSA.Visualization.plotMDS(ec_rdms, 'dimensions', [1 2 3]);    
...
figure;
RSA.Visualization.plotMDS(ec_rdms, 'iconPath', iconpath, 'nodeColors', nodecolors);
...
RSA.Visualization.plotMDS(ec_rdms, 'nodeLabels', nodelabels, 'nodeColors', nodecolors);
