...
% This script tests the functionality of RDM_Computation.computeClassificationRDM()
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix);
    disp('Test 1 passed.');
catch
    disp('Test 1 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(pairwiseMatrix, 'matrixtype', 'pairwise');
    disp('Test 2 passed.');
catch
    disp('Test 2 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'normalize', 'sum');
    disp('Test 3 passed.');
catch
    disp('Test 3 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'normalize', 'diagonal');
    disp('Test 4 passed.');
catch
    disp('Test 4 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'normalize', 'none');
    disp('Test 5 passed.');
catch
    disp('Test 5 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'symmetrize', 'arithmetic');
    disp('Test 6 passed.');
catch
    disp('Test 6 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'symmetrize', 'geometric');
    disp('Test 7 passed.');
catch
    disp('Test 7 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'symmetrize', 'harmonic');
    disp('Test 8 passed.');
catch
    disp('Test 8 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'symmetrize', 'none');
    disp('Test 9 passed.');
catch
    disp('Test 9 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'distance', 'linear');
    disp('Test 10 passed.');
catch
    disp('Test 10 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'distance', 'power', 'distpower', 2);
    disp('Test 11 passed.');
catch
    disp('Test 11 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'distance', 'logarithmic', 'distpower', 2);
    disp('Test 12 passed.');
catch
    disp('Test 12 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'distance', 'none');
    disp('Test 13 passed.');
catch
    disp('Test 13 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'rankdistances', 'rank');
    disp('Test 14 passed.');
catch
    disp('Test 14 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'rankdistances', 'percentrank');
    disp('Test 15 passed.');
catch
    disp('Test 15 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'rankdistances', 'none');
    disp('Test 16 passed.');
catch
    disp('Test 16 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'matrixtype', 'auto');
    disp('Test 17 passed.');
catch
    disp('Test 17 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'matrixtype', 'cm');
    disp('Test 18 passed.');
catch
    disp('Test 18 failed.');
end
...
try
    [RDM, params] = RDM_Computation.computeClassificationRDM(confMatrix, 'matrixtype', 'invalid');
