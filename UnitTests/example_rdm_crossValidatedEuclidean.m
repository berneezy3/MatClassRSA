% example_rdm_crossValidatedEuclidean.m
% ---------------------
% Nathan - Aug 19, 2019
%
% Example code for compute an RDM using the cross-validated Euclidean
% correlation using computeEuclideanRDM.m.
...
for i=1:n_time
    ...
    data = squeeze(X(:,i,:));
    rdms = computeEuclideanRDM(data, labels72, n_perm);
